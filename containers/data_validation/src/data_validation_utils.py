...
def get_schema_html(schema: schema_pb2.Schema):
  ...
  return features.to_html(classes="paleBlueRows"), domains.to_html(classes="paleBlueRows")


def get_anomalies_html(anomalies: anomalies_pb2.Anomalies):
  ...
  if not anomaly_rows:
    anomalies = '<h3 style="color:green;">No anomalies found.</h3>'
  else:
    ...
    anomalies = anomalies.to_html(classes="paleBlueRows")
